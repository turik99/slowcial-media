...
function FindFriends(props: FindFriendsProps){
    ...
    const ProfileResult = (props: ProfileResultProps) => {
        ...
        } } style={{display: "flex", marginTop: "12px", flexDirection: "row", height: "48px", justifyContent: "right", alignItems: "center", paddingLeft: "12px"}}>
            <p style={{marginLeft: "12px", marginRight: 'auto', fontSize: "15px"}}>{props.user.username}</p>
